"""Mock Cliq API — electronics retailer backend.

Deliberately uses Cliq-ish conventions: RESTful resources, camelCase,
...
Run: uvicorn mocks.cliq.app:app --port 9002
"""
...
async def lifespan(app: FastAPI):
    # catalog + surviving carts/orders come from Cliq's own Supabase tables
    await store.load()
    yield


app = FastAPI(title="Mock Cliq API", lifespan=lifespan)
