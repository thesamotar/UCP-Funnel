"""Cliq cart operations: create, add entry, get (REST style)."""
...
@router.get("/cliq/api/v2/cart/{cart_id}")
...
@router.delete("/cliq/api/v2/cart/{cart_id}/entries/{product_code}")
