"""Ihcl cart operations: create, add entry, get (REST style)."""
...
@router.post("/ihcl/api/v2/cart/{cart_id}/entries")
...
@router.get("/ihcl/api/v2/cart/{cart_id}")
...
@router.delete("/ihcl/api/v2/cart/{cart_id}/entries/{product_code}")
