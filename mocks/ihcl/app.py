"""Mock Ihcl API — electronics retailer backend.

Deliberately uses Ihcl-ish conventions: RESTful resources, camelCase,
...
Run: uvicorn mocks.ihcl.app:app --port 9002
"""
...
async def lifespan(app: FastAPI):
    # catalog + surviving carts/orders come from Ihcl's own Supabase tables
    await store.load()
    yield


app = FastAPI(title="Mock Ihcl API", lifespan=lifespan)
