"""Mock Zudio API — electronics retailer backend.

Deliberately uses Zudio-ish conventions: RESTful resources, camelCase,
...
Run: uvicorn mocks.zudio.app:app --port 9002
"""
...
async def lifespan(app: FastAPI):
    # catalog + surviving carts/orders come from Zudio's own Supabase tables
    await store.load()
    yield


app = FastAPI(title="Mock Zudio API", lifespan=lifespan)
