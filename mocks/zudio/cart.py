"""Zudio cart operations: create, add entry, get (REST style)."""
...
@router.post("/zudio/api/v2/cart/{cart_id}/entries")
...
@router.get("/zudio/api/v2/cart/{cart_id}")
...
@router.delete("/zudio/api/v2/cart/{cart_id}/entries/{product_code}")
