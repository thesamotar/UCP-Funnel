"""Mock OneMg API — electronics retailer backend.

Deliberately uses OneMg-ish conventions: RESTful resources, camelCase,
...
Run: uvicorn mocks.onemg.app:app --port 9002
"""
...
async def lifespan(app: FastAPI):
    # catalog + surviving carts/orders come from OneMg's own Supabase tables
    await store.load()
    yield


app = FastAPI(title="Mock OneMg API", lifespan=lifespan)
