"""OneMg cart operations: create, add entry, get (REST style)."""
...
@router.get("/onemg/api/v2/cart/{cart_id}")
...
@router.delete("/onemg/api/v2/cart/{cart_id}/entries/{product_code}")
